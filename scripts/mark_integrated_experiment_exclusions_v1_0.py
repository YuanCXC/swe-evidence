...
# -*- coding: utf-8 -*-
"""
mark_integrated_experiment_exclusions_v1_0.py
...
用法：
  # dry-run
  python scripts/mark_integrated_experiment_exclusions_v1_0.py

  # apply
  python scripts/mark_integrated_experiment_exclusions_v1_0.py --apply
"""
