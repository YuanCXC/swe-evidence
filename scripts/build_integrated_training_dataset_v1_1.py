...
建议项目位置：
    scripts/build_integrated_training_dataset_v1_1.py
"""
...
OUTPUT_DATASET_VERSION = "2.10.0+strong_teacher_mechanical_v1.1"
...
class PolicyRuntime:
    ...
    def __init__(self, *, builder_path: Path, build_db: Path, fts_db: Path):
        ...
        self.fts = _sqlite_ro(self.fts_db)
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        ...
        help="V2.10 policy rebuild 使用的冻结 FTS sidecar。",
    )
    p.add_argument(
        "--builder",
        type=Path,
